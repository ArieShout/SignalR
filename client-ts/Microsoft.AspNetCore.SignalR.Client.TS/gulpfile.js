...
gulp.task('browserify-client', ['compile-ts-client'], () => {
    return browserifyModule('ServiceClient.js', 'signalR', 'signalr-client.js');
});
...
gulp.task('browserify-clientES5', ['compile-ts-client'], () => {
    return browserifyModuleES5('ServiceClient.js', 'signalR', 'signalr-clientES5.js', /*hasAsync*/ true);
});
