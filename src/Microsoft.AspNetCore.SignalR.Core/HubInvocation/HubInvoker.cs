...
{
    public class HubInvoker<THub> : IHubInvoker<THub> where THub : Hub
    {
        ...
        private readonly ILogger<HubInvoker<THub>> _logger;

        public HubInvoker(ILogger<HubInvoker<THub>> logger, IServiceScopeFactory serviceScopeFactory, IHubContext<THub> hubContext)
        {
            _logger = logger;
