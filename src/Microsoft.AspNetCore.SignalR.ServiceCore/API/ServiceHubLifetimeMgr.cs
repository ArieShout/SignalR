...
{
    public abstract class ServiceHubLifetimeMgr<THub>
    {
        public abstract Task OnConnectedAsync(ServiceHubConnectionContext connection);

        public abstract Task OnDisconnectedAsync(ServiceHubConnectionContext connection);
