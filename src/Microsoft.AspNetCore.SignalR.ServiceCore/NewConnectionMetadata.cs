...
{
    internal class NewConnectionMetadata : IDictionary<object, object>
    {
        public NewConnectionMetadata()
            : this(new Dictionary<object, object>())
        {
        }

        public NewConnectionMetadata(IDictionary<object, object> items)
        {
            Items = items;
        }
