...
{
    public class NewDefaultConnectionContext : DefaultConnectionContext,
                                            ...
                                            ITransferModeFeature
    {
        ...
        public NewDefaultConnectionContext(string id, Channel<byte[]> transport, Channel<byte[]> application) : base(id, transport, application)
        {
            Transport = transport;
        ...
        public new CancellationTokenSource Cancellation { get; set; }

        public new SemaphoreSlim Lock { get; } = new SemaphoreSlim(1, 1);

        public new Task TransportTask { get; set; }

        public new Task ApplicationTask { get; set; }

        public new DateTime LastSeenUtc { get; set; }

        public new ConnectionStatus Status { get; set; } = ConnectionStatus.Inactive;
        ...
        public override IDictionary<object, object> Metadata { get; set; } = new NewConnectionMetadata();

        public new Channel<byte[]> Application { get; }

        public override Channel<byte[]> Transport { get; set; }

        public new TransferMode TransportCapabilities { get; set; }

        public new TransferMode TransferMode { get; set; }
        ...
        public new enum ConnectionStatus
        {
            Inactive,
            Active,
            Disposed
