...
{
    public class NewHubConnectionContext : HubConnectionContext
    {
        ...
        public NewHubConnectionContext(ChannelWriter<HubMessage> output, ConnectionContext connectionContext) : base(output, connectionContext)
        {
            _output = output;
        ...
        {
            var connection = (NewHubConnectionContext)state;
            try
            {
