...
{
    class ServiceHubGroupList : IReadOnlyCollection<ConcurrentDictionary<string, ServiceHubConnectionContext>>
    {
        ...
        public ConcurrentDictionary<string, ServiceHubConnectionContext> this[string groupName]
        {
            get
            {
        ...
        public void Add(ServiceHubConnectionContext connection, string groupName)
        {
        ...
        public IEnumerator<ConcurrentDictionary<string, ServiceHubConnectionContext>> GetEnumerator()
        {
        ...
        private void CreateOrUpdateGroupWithConnection(string groupName, ServiceHubConnectionContext connection)
        {
        ...
        private static GroupConnectionList AddConnectionToGroup(
            ServiceHubConnectionContext connection, GroupConnectionList group)
        {
    ...
    internal class GroupConnectionList : ConcurrentDictionary<string, ServiceHubConnectionContext>
    {
        public override bool Equals(object obj)
        {
            if (obj is ConcurrentDictionary<string, ServiceHubConnectionContext> list)
            {
