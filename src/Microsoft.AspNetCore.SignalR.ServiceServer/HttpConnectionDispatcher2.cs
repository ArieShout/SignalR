...
{
    public class HttpConnectionDispatcher2 : HttpConnectionDispatcher
    {
        private readonly ConnectionManager _manager;
        private readonly ILoggerFactory _loggerFactory;
        private readonly ILogger _logger;

        public HttpConnectionDispatcher2(ConnectionManager manager, ILoggerFactory loggerFactory) : base(manager, loggerFactory)
        {
            _manager = manager;
            _loggerFactory = loggerFactory;
            _logger = _loggerFactory.CreateLogger<HttpConnectionDispatcher2>();
        }

        public new async Task ExecuteAsync(HttpContext context, HttpSocketOptions options, SocketDelegate socketDelegate)
        {
            var hubName = context.GetRouteValue("hubName").ToString();
        ...
        public new async Task ExecuteNegotiateAsync(HttpContext context, HttpSocketOptions options)
        {
